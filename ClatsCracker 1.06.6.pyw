...
hash_lengths = {
    'crc32': 8, 'adler32': 8,
    'md4': 32, 'md5': 32, 'ripemd160': 40, 'sha1': 40, 'sha1_v2': 40,
    ...
    'shake128': 64, 'shake256': 128, 'shakeke128': 64,
    'sm3': 64, 'md5_sha1': 72, 'mdc2': 32, 'whirlpool': 128,
    'scrypt': 128
}
...
_HASH_FUNCS = {
    ...
    'md5_sha1':     lambda b: hashlib.new('md5-sha1', b).hexdigest(),
    'mdc2':         lambda b: hashlib.new('mdc2', b).hexdigest(),
    'whirlpool':    lambda b: hashlib.new('whirlpool', b).hexdigest(),
}
...
class HashCrackerGUI:
    def __init__(self, master: tk.Tk):
        self.master = master
        master.title("ClatsCracker Hash Tool GUI v1.06.6")
...
╚██████╗███████╗██║  ██║   ██║   ███████║╚██████╗██║  ██║██║  ██║╚██████╗██║  ██╗███████╗██║  ██║
 ╚═════╝╚══════╝╚═╝  ╚═╝   ╚═╝   ╚══════╝ ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
           C L A T S C R A C K E R     H A S H     T O O L   (Version 1.06.6)
